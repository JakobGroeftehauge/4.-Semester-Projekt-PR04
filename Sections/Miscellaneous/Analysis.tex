...
Instead of using a \textit{single} controller for the plant, sometimes it can be beneficial to implement multiple controllers in a cascaded design. % as shown on figure \ref{fig:cascaded_design_analysis}. 
