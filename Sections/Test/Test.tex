...
\begin{figure}[h]
     ...
     \end{subfigure}
        \caption{Step response of a single velocity controller on the tilt motor. \ref{fig:StepVelZN} is tuned using Ziegler-Nichols and \ref{fig:StepVelModel} is tuned using the pole placement method. The measured response being an average of five tests.}
...
\begin{figure}[h]
     ...
     \end{subfigure}
        \caption{Stepresponse of a cascaded PID-controller for the position of the tilt motor. The measured response being an average of five tests.}
...
\begin{figure}[h]
    ...
    \caption{Position step response using a cascaded controller on the pan motor. The measured response being an average of five tests.}
