...
\end{equation}
where $ U_{CPU} $ is the CPU utilisation, $t_{1,avg}$ and $ t_{2,avg}$ is the average duration of $t_1$ and $t_2$ and $T_{avg}$ is the average time of $T_c$ as seen on figure \ref{fig:Schedueling_controllers}. 
