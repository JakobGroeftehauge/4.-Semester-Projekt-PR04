...
The inertia estimates are based on a simplified representation of the pan and tilt system shown in figure \ref{}. This representation ignores bolts, brackets, gears, etc. Furthermore, the extrusions are considered as solid boxes, thus ignoring the profile shape.
